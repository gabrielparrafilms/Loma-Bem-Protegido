    ...
    <section id="social-proof" className="relative z-20 w-full py-16 lg:py-32 flex flex-col items-center justify-center overflow-hidden border-t border-white/5 bg-transparent">
      ...
      <div className="w-full max-w-[1400px] mx-auto px-6 md:px-12 relative z-10 flex flex-col items-center gap-16 md:gap-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8 w-full max-w-5xl">
          <div className="bg-[#131316] rounded-3xl flex flex-col items-center justify-center p-8 md:p-16 relative overflow-hidden animate-on-scroll [animation:animationIn_0.8s_ease-out_0.2s_both] border border-white/5 group shadow-[0_20px_40px_rgba(0,0,0,0.4)]">
          ...
          <div className="bg-[#131316] rounded-3xl flex flex-col items-center justify-center p-8 md:p-16 relative overflow-hidden animate-on-scroll [animation:animationIn_0.8s_ease-out_0.3s_both] border border-white/5 group shadow-[0_20px_40px_rgba(0,0,0,0.4)]">
            <div className="absolute inset-0 bg-gradient-to-br from-[#0ABAB5]/5 to-transparent opacity-50" aria-hidden="true" />
